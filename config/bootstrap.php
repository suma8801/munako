...
/*
 * 詳細なAPI情報については https://github.com/josegonzalez/php-dotenv を参照してください。
 *
 * 開発中に `.env` ファイルを使用したい場合は、以下のコードブロックのコメントを解除してください。
 * `config/.env.example` を `config/.env` にコピーし、必要に応じて変数を設定・修正してください。
 *
 * .env ファイルの目的は、本番環境に存在する環境変数の存在を模倣することです。
 *
 * .env ファイルを使用する場合は、セキュリティリスクを避けるため、
 * ソース管理にコミットしないよう注意してください。
 * 推奨される実践方法については https://github.com/josegonzalez/php-dotenv#general-security-information
 * を参照してください。
*/
